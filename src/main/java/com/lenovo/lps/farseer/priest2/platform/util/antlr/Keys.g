...
sysdate_interval_key
    :    {(input.LT(1).getText() + input.LT(2).getText() + input.LT(3).getText()).equalsIgnoreCase("sysdate-interval")}? REGULAR_ID MINUS_SIGN REGULAR_ID -> ^(FUNC_NAME REGULAR_ID MINUS_SIGN REGULAR_ID)
    ;

...
if ! rpm -qa | grep -q graphviz ; then
		if ! rpm -qa | grep -q libX11-common-1.6.3 ; then
			sudo rpm -ivh /var/lib/priest/graphviz/libX11-common-1.6.3-2.el6.noarch.rpm
		fi
		if ! rpm -qa | grep -q libX11-1.6.3 ; then
			sudo rpm -ivh /var/lib/priest/graphviz/libX11-1.6.3-2.el6.x86_64.rpm
		fi
		if ! rpm -qa | grep -q libXpm-3.5.10 ; then
			sudo rpm -ivh /var/lib/priest/graphviz/libXpm-3.5.10-2.el6.x86_64.rpm
		fi
		if ! rpm -qa | grep -q gd-2.0.35 ; then
			sudo rpm -ivh /var/lib/priest/graphviz/gd-2.0.35-11.el6.x86_64.rpm
		fi
		if ! rpm -qa | grep -q libICE-1.0.6 ; then
			sudo rpm -ivh /var/lib/priest/graphviz/libICE-1.0.6-1.el6.x86_64.rpm 
		fi
		if ! rpm -qa | grep -q libSM-1.2.1 ; then
			sudo rpm -ivh /var/lib/priest/graphviz/libSM-1.2.1-2.el6.x86_64.rpm
		fi
		if ! rpm -qa | grep -q libXt-1.1.4 ; then
			sudo rpm -ivh /var/lib/priest/graphviz/libXt-1.1.4-6.1.el6.x86_64.rpm
		fi
		if ! rpm -qa | grep -q libXmu-1.1.1 ; then
			sudo rpm -ivh /var/lib/priest/graphviz/libXmu-1.1.1-2.el6.x86_64.rpm
		fi
		if ! rpm -qa | grep -q libXaw-1.0.11 ; then
			sudo rpm -ivh /var/lib/priest/graphviz/libXaw-1.0.11-2.el6.x86_64.rpm
		fi
		if ! rpm -qa | grep -q tcl-8.5.7 ; then
			sudo rpm -ivh /var/lib/priest/graphviz/tcl-8.5.7-6.el6.x86_64.rpm
		fi
		if ! rpm -qa | grep -q tk-8.5.7 ; then
			sudo rpm -ivh /var/lib/priest/graphviz/tk-8.5.7-5.el6.x86_64.rpm 
		fi
		if ! rpm -qa | grep -q php-common-5.3.3 ; then
			sudo rpm -ivh /var/lib/priest/graphviz/php-common-5.3.3-48.el6_8.x86_64.rpm
		fi
		if ! rpm -qa | grep -q libtool-ltdl-2.2.6 ; then
			sudo rpm -ivh /var/lib/priest/graphviz/libtool-ltdl-2.2.6-15.5.el6.x86_64.rpm 
		fi
		if ! rpm -qa | grep -q guile-1.8.7 ; then
			sudo rpm -ivh /var/lib/priest/graphviz/guile-1.8.7-5.el6.x86_64.rpm
		fi
		if ! rpm -qa | grep -q libfontenc-1.1.2 ; then
			sudo rpm -ivh /var/lib/priest/graphviz/libfontenc-1.1.2-3.el6.x86_64.rpm 
		fi
		if ! rpm -qa | grep -q libXfont-1.5.1 ; then
			sudo rpm -ivh /var/lib/priest/graphviz/libXfont-1.5.1-2.el6.x86_64.rpm
		fi
		if ! rpm -qa | grep -q xorg-x11-font-utils-7.2 ; then
			sudo rpm -ivh /var/lib/priest/graphviz/xorg-x11-font-utils-7.2-11.el6.x86_64.rpm
		fi
		if ! rpm -qa | grep -q urw-fonts-2.4 ; then
			sudo rpm -ivh /var/lib/priest/graphviz/urw-fonts-2.4-11.el6.noarch.rpm 
		fi
		if ! rpm -qa | grep -q compat-readline5-5.2 ; then
			sudo rpm -ivh /var/lib/priest/graphviz/compat-readline5-5.2-17.1.el6.x86_64.rpm 
		fi
		if ! rpm -qa | grep -q ruby-libs-1.8.7 ; then
			sudo rpm -ivh /var/lib/priest/graphviz/ruby-libs-1.8.7.374-4.el6_6.x86_64.rpm 
		fi
		if ! rpm -qa | grep -q ruby-1.8.7 ; then
			sudo rpm -ivh /var/lib/priest/graphviz/ruby-1.8.7.374-4.el6_6.x86_64.rpm 
		fi		
...
export JAVA_HOME=/var/lib/priest/jdk1.7.0_67-cloudera
export JETTY_HOME=/var/lib/priest
# Configuration files
#
# /etc/default/jetty
...
# Setup JAVA if unset
##################################################
JAVA=/var/lib/priest/jdk1.7.0_67-cloudera/bin/java
if [ -z "$JAVA" ]
then
  JAVA=$(which java)
fi
